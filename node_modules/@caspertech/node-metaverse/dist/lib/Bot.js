...
class Bot {
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._clientCommands = new ClientCommands_1.ClientCommands(response.region, response.agent, this);
    ...
    changeRegion(region, requested) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._clientCommands = new ClientCommands_1.ClientCommands(this.currentRegion, this.agent, this);
    ...
    connectToSim(requested = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield circuit.waitForAck(circuit.sendMessage(msg, PacketFlags_1.PacketFlags.Reliable), 60000);
            ...
            let regionName = null;
            circuit.waitForMessage(Message_1.Message.AgentMovementComplete, 60000).then((agentMovementMsg) => {
                ...
                if (this.pingNumber % 12 === 0 && this.stay) {
                    if (this.currentRegion.regionName.toLowerCase() !== this.stayRegion.toLowerCase()) {
                        ...
                        if (this.stayPosition === undefined) {
                            this.stayPosition = new Vector3_1.Vector3([128, 128, 20]);
                        }
