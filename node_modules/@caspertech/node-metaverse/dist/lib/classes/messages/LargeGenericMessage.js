...
exports.LargeGenericMessageMessage = void 0;
const UUID_1 = require("../UUID");
const MessageFlags_1 = require("../../enums/MessageFlags");
const Message_1 = require("../../enums/Message");
class LargeGenericMessageMessage {
    constructor() {
        this.name = 'LargeGenericMessage';
        this.messageFlags = MessageFlags_1.MessageFlags.Deprecated | MessageFlags_1.MessageFlags.FrequencyLow;
        this.id = Message_1.Message.LargeGenericMessage;
    }
    getSize() {
...
exports.LargeGenericMessageMessage = LargeGenericMessageMessage;
//# sourceMappingURL=LargeGenericMessage.js.map