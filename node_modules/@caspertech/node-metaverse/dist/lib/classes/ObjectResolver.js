...
class ObjectResolver {
    constructor(region) {
        ...
        this.onObjectResolveRan = new rxjs_1.Subject();
    }
    resolveObjects(objects, forceResolve = false, skipInventory = false, log = false) {
        return new Promise((resolve, reject) => {
            ...
            let objResolve = undefined;
            let objProps = undefined;
            ...
            objResolve = this.onObjectResolveRan.subscribe((obj) => {
            ...
            objProps = this.region.clientEvents.onObjectResolvedEvent.subscribe((obj) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (objectList.length > 0) {
                    ...
                    yield this.region.clientCommands.region.selectObjects(objectList);
                    // console.log('Deselecting ' + objectList.length + ' objects');
                    if (!this.region) {
                        return;
                    }
                    yield this.region.clientCommands.region.deselectObjects(objectList);
                ...
                for (const job of jobs) {
                    ...
                    if (!job.skipInventory) {
                        const o = job.object;
                        if ((o.resolveAttempts === undefined || o.resolveAttempts < 3) && o.FullID !== undefined && o.name !== undefined && o.Flags !== undefined && !(o.Flags & __1.PrimFlags.InventoryEmpty) && (!o.inventory || o.inventory.length === 0)) {
                            if (job.log) {
                                // console.log('Processing inventory for ' + job.object.ID);
                            }
                            try {
                                yield o.updateInventory();
                            }
                            catch (error) {
                ...
                const that = this;
                const getCosts = function (objIDs) {
                    return __awaiter(this, void 0, void 0, function* () {
                        if (!that.region) {
                            return;
                        }
                        const result = yield that.region.caps.capsPostXML('GetObjectCost', {
                            'object_ids': objIDs
                        });
                        ...
                        for (const key of uuids) {
                            ...
                            try {
                                ...
                                const obj = that.region.objects.getObjectByUUID(new __1.UUID(key));
                                ...
                                if (obj.Flags !== undefined && obj.Flags & __1.PrimFlags.TemporaryOnRez && obj.limitingType === 'legacy') {
