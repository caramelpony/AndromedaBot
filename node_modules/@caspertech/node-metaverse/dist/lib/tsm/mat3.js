...
class TSMMat3 {
    ...
    multiplyTSMVec2(vector, result = null) {
        ...
        if (result) {
            ...
            return new vec2_1.TSMVec2([
                x * this.values[0] + y * this.values[3] + this.values[6],
                x * this.values[1] + y * this.values[4] + this.values[7]
            ]);
        }
    }
    multiplyTSMVec3(vector, result = null) {
    ...
    toQuat() {
        ...
        const result = new quat_1.TSMQuat();
        switch (biggestIndex) {
            case 0:
                result.w = biggestVal;
...
exports.TSMMat3 = TSMMat3;
TSMMat3.identity = new TSMMat3().setIdentity();
