...
class TSMQuat {
    ...
    multiplyTSMVec3(vector, dest = null) {
        if (!dest) {
            dest = new vec3_1.TSMVec3();
        }
...
exports.TSMQuat = TSMQuat;
TSMQuat.identity = new TSMQuat().setIdentity();
