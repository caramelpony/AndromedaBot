...
class TSMVec3 {
    ...
    multiplyByTSMMat3(matrix, dest = null) {
        if (!dest) {
            dest = this;
        }
        return matrix.multiplyTSMVec3(this, dest);
    }
    multiplyByTSMQuat(src, dest = null) {
        if (!dest) {
            dest = this;
        }
...
exports.TSMVec3 = TSMVec3;
TSMVec3.zero = new TSMVec3([0, 0, 0]);
TSMVec3.up = new TSMVec3([0, 1, 0]);
TSMVec3.right = new TSMVec3([1, 0, 0]);
TSMVec3.forward = new TSMVec3([0, 0, 1]);
